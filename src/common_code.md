...
期间，使用`Python`代码，对于`Android`设备的操作，整理了一些常用的代码逻辑，代码段，代码块。

已整理并发布到自己Crifan的库中了：

* https://github.com/crifan/crifanLibPython/blob/master/python3/crifanLib/thirdParty/crifanAndroid.py
